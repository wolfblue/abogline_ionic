...
@Component({
  ...
  templateUrl: './admin-nosotros.page.html',
  styleUrls: ['./admin-nosotros.page.scss'],
})
export class AdminNosotrosPage implements OnInit {
  ...
  actualizar(){
    ...
    apiAdminUpdate.append("tipo","nosotros");
