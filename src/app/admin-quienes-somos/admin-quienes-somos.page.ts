...
@Component({
  ...
  templateUrl: './admin-quienes-somos.page.html',
  styleUrls: ['./admin-quienes-somos.page.scss'],
})
export class AdminQuienesSomosPage implements OnInit {
  ...
  actualizar(){
    ...
    apiAdminUpdate.append("tipo","quienes-somos");
